(function () {
  ...
  function init() {
    ...
    style.textContent = `
      ...
      #chatbot-input button{background:#198754;color:#fff;border:0;border-radius:8px;padding:8px 12px;cursor:pointer;font-weight:600}
    ...
    async function sendMessage(){
      ...
      try{
        ...
        hideLoading();
        if(!res.ok){ appendMessage("Hubo un problema procesando tu mensaje.", "bot"); return; }
